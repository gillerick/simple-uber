...
// SimpleUber is a struct for the representing the app's configuration. envconfig tag key has been added to also enable reading properties from envs
type SimpleUber struct {
	Host string `yaml:"host" envconfig:"SIMPLE_UBER_HOST"`
	Port string `yaml:"port" envconfig:"SIMPLE_UBER_PORT"`
}
